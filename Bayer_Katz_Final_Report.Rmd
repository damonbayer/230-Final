...
We note that the transformed t-link point estimates closesly match the Stan model coefficients as well as the maximum likelihood estimates. The Gibbs sample trace plot exhibit strong autocoreelation in some plots, but the posterior distributions look fairly normal. There are no obvious problems with the posterior distributions generated with the Stan model.
